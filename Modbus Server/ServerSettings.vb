...
#End If
    ...
    Public Sub OpenPulseLogFile()
        ...
        Else
            ...
            pulse_log_file.Write("Pulse Seconds, ")
            pulse_log_file.Write("Pulse Milliseconds, ")
            pulse_log_file.Write("HTR Target, ")
            pulse_log_file.Write("HTR Set Point, ")
            pulse_log_file.Write("HTR POT, ")
            pulse_log_file.Write("N/A, ")
            pulse_log_file.Write("N/A, ")
            pulse_log_file.Write("N/A, ")
            pulse_log_file.Write("N/A, ")
            pulse_log_file.Write("N/A, ")
            ...
            pulse_log_file.Write("N/A, ")
            pulse_log_file.Write("N/A, ")
            pulse_log_file.Write("State, ")
            pulse_log_file.Write("HTR Vmon, ")
            pulse_log_file.Write("HTR Imon, ")
            pulse_log_file.Write("ECB Message Count")
            pulse_log_file.WriteLine("")
        End If
